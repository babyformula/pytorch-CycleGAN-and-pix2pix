...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='f2m_cyclegan', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--verbose', default=True, help='if specified, print more debugging information')
